        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    <!--begin::Form-->
                    <form method="POST" class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('login.store') }}">
                        @csrf
                        <!--begin::Heading-->
                        <div class="text-center mb-11">
                            ...
                            <!--end::Title-->
                            <!--begin::Subtitle-->
                            <div class="text-gray-500 fw-semibold fs-6">Nom de la société</div>
                            <!--end::Subtitle=-->
                        </div>
                        @if(session('error'))
                        ...
                        <div class="row g-3 mb-9">
                            ...
                            <div class="col-md-6">
                                <!--begin::Google link=-->
                                <a href="{{ route('social.redirect', 'google') }}" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                    <img alt="Logo" src="{{ asset('/assets/media/svg/brand-logos/google-icon.svg') }}" class="h-15px me-3" />Connexion avec Google</a>
                                <!--end::Google link=-->
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
