...
class SettingBankIncome extends Component implements HasForms, HasTable
{
    ...
    {
        return $table
            ->query($this->account->mouvements()->getQuery()->where('future', true)->newQuery())
            ->columns([
    ...
    {
        return view('livewire.core.setting-bank-income');
    }
}
